...
run(function()
	...
	if not lstats then
		repeat
			lstats = lplr:FindFirstChild('TempPlayerStatsModule')
			task.wait()
		until lstats or xyphrion.Loaded == nil
	...
	xyphrion:Clean(mapval:GetPropertyChangedSignal('Value'):Connect(updateMap))
	if mapval.Value then
		updateMap()
	end
end)
...
run(function()
	...
	entitylib.getEntityColor = function(ent)
		if not (ent.Player and xyphrion.Categories.Main.Options['Use team color'].Enabled) then return end
...
run(function()
    ...
    NoSlowdown = xyphrion.Categories.Blatant:CreateModule({
        Name = 'No Slow',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    PhaseHammer = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Phase Hammer',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    RopeDisabler = xyphrion.Categories.Utility:CreateModule({
        Name = 'Restrain Beast',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    SlowBeast = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Slow Beast',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    SpamBeast = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Spam Beast',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    ComputerESP = xyphrion.Categories.Render:CreateModule({
        Name = 'Computer ESP',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoComputer = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Computer',
        Function = function(callback)
            if callback then
                repeat
