...
run(function()
	...
	if not pl.Bullet then
		repeat
			getShootFunction()
			task.wait()
		until pl.Bullet or xyphrion.Loaded == nil
	...
	xyphrion:Clean(replicatedStorage.Killfeed.ChildAdded:Connect(SessionAdded))
	for _, v in replicatedStorage.Killfeed:GetChildren() do
		SessionAdded(v)
	end

	xyphrion:Clean(vapeEvents.Arrested.Event:Connect(function()
		arrests:Increment()
	end))

	OriginScanner:UpdateIgnore()
	for _, v in {'EntityAdded', 'LocalAdded'} do
		xyphrion:Clean(entitylib.Events[v]:Connect(function()
			OriginScanner:UpdateIgnore()
		end))
	end
...
run(function()
    ...
    AntiInvisible = xyphrion.Categories.Blatant:CreateModule({
        Name = 'AntiInvisible',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AntiKillPlane = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    AntiRiotShield = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    AntiTaze = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Anti Taze',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoArrest = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Auto Arrest',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    AutoReset = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Auto Reset',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    NoJumpCooldown = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    VehicleFly = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Vehicle Fly',
        Function = function(callback)
            if callback then
                up, down = 0, 0
...
run(function()
    ...
    VehicleSpeed = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Vehicle Speed',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    VehicleWallbang = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    C4ESP = xyphrion.Categories.Render:CreateModule({
        Name = 'C4 ESP',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    KillNotifications = xyphrion.Categories.Render:CreateModule({
...
run(function()
    ...
    AutoDetonate = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Detonate',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoHeal = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Heal',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    AutoPickup = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Pickup',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoReload = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Reload',
        Function = function(callback)
            if callback then
