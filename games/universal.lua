local loadstring = function(...)
	...
	if err and vape then
		xyphrion:CreateNotification('Vape', 'Failed to load : '..err, 30, 'alert')
	end
	return res
end
...
xyphrion:Clean(lplr.OnTeleport:Connect(function()
...
local hash = loadstring(downloadFile('xyphrion/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('xyphrion/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('xyphrion/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	tagcallback = {},
...
run(function()
	...
	entitylib.targetCheck = function(ent)
		...
		if xyphrion.Categories.Main.Options['Teams by server'].Enabled then
	...
	entitylib.getEntityColor = function(ent)
		ent = ent.Player
		if not (ent and xyphrion.Categories.Main.Options['Use team color'].Enabled) then return end
		if isFriend(ent, true) then
			return Color3.fromHSV(xyphrion.Categories.Friends.Options['Friends color'].Hue, xyphrion.Categories.Friends.Options['Friends color'].Sat, xyphrion.Categories.Friends.Options['Friends color'].Value)
		end
	...
	xyphrion:Clean(xyphrion.Categories.Friends.Update.Event:Connect(function() entitylib.refresh() end))
	xyphrion:Clean(xyphrion.Categories.Targets.Update.Event:Connect(function() entitylib.refresh() end))
	xyphrion:Clean(entitylib.Events.LocalAdded:Connect(updateVelocity))
	xyphrion:Clean(workspace:GetPropertyChangedSignal('CurrentCamera'):Connect(function()
...
run(function()
	...
	function whitelist:announce(text)
		...
		if success then
			return sendToast({
				toastTitle = text,
				iconImage = getcustomasset('xyphrion/assets/new/vape.png'),
				swipeUpDismiss = true,
		...
		icon.Image = getcustomasset('xyphrion/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('xyphrion/profiles/whitelist.json') and readfile('xyphrion/profiles/whitelist.json') or nil
			end
			...
			if not whitelist.connection then
				...
				xyphrion:Clean(whitelist.connection)
			end
			...
			if entitylib.Running and xyphrion.Loaded then
				entitylib.refresh()
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('xyphrion/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
    ...
    run(function()
    	...
    	SilentAim = xyphrion.Categories.Combat:CreateModule({
    		Name = 'Silent Aim',
    		Function = function(callback)
    			if CircleObject then
...
run(function()
    ...
    HighJump = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'High Jump',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    InfiniteJump = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Infinite Jump',
        Function = function(callback)
            if callback then
                local jumps = 0
...
run(function()
    ...
    Invisible = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Invisible',
    	Function = function(callback)
    		if callback then
    			animationTrickery()
...
run(function()
    ...
    Jesus = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Jesus',
    	Function = function(callback)
    		if callback then
    			local terrain = workspace:FindFirstChildWhichIsA('Terrain')
...
run(function()
    ...
    Phase = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Phase',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    SpinBot = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Spin Bot',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    Swim = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Swim',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    TargetStrafe = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Target Strafe',
    	Function = function(callback)
    		if callback then
    			if not module then
...
run(function()
    ...
    Timer = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Timer',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    Arrows = xyphrion.Categories.Render:CreateModule({
    	Name = 'Arrows',
    	Function = function(callback)
    		if callback then
    			...
    			Arrows:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
    ...
    Chams = xyphrion.Categories.Render:CreateModule({
    	Name = 'Chams',
    	Function = function(callback)
    		if callback then
    			...
    			Chams:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
    ...
    ESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'ESP',
    	Function = function(callback)
    		if callback then
    			...
    			if ColorFunc[methodused] then
    				ESP:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
    ...
    Fullbright = xyphrion.Categories.Render:CreateModule({
    	Name = 'Fullbright',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    GamingChair = xyphrion.Categories.Render:CreateModule({
    	Name = 'Gaming Chair',
    	Function = function(callback)
    		if callback then
    			if vape.ThreadFix then
...
run(function()
    ...
    PlayerModel = xyphrion.Categories.Render:CreateModule({
    	Name = 'Player Model',
    	Function = function(callback)
    		if callback then 
    ...
    Radar = xyphrion:CreateOverlay({
    	...
    	Function = function(callback)
    		if callback then
    			...
    			Radar:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
    ...
    Search = xyphrion.Categories.Render:CreateModule({
    	Name = 'Search',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    SessionInfo = xyphrion:CreateOverlay({
    	Name = 'Session Info',
    ...
    xyphrion:Clean(SessionInfo.Children:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
    	if vape.ThreadFix then
    		setthreadidentity(8)
    	end
...
run(function()
    ...
    Tracers = xyphrion.Categories.Render:CreateModule({
    	Name = 'Tracers',
    	Function = function(callback)
    		if callback then
    			...
    			Tracers:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
    				ColorFunc(Color.Hue, Color.Sat, Color.Value)
    			end))
...
run(function()
    ...
    Waypoints = xyphrion.Categories.Render:CreateModule({
    	Name = 'Waypoints',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    AnimationPlayer = xyphrion.Categories.Utility:CreateModule({
...
run(function()
    ...
    AntiRagdoll = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Anti Ragdoll',
    	Function = function(callback)
    		if entitylib.isAlive then
...
run(function()
    ...
    AutoRejoin = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Auto Rejoin',
    	Function = function(callback)
    		if callback then
    			local check
...
run(function()
    ...
    Blink = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Blink',
    	Function = function(callback)
    		if callback then
    			local teleported
...
run(function()
    ...
    ChatSpammer = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Chat Spammer',
    	Function = function(callback)
    		if callback then
    			if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
...
run(function()
    ...
    Disabler = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Disabler',
    	Function = function(callback)
    		if callback then
...
run(function()
    xyphrion.Categories.Utility:CreateModule({
    	Name = 'Panic',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    Rejoin = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Rejoin',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    ServerHop = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Server Hop',
    	Function = function(callback)
    		if callback then
    			ServerHop:Toggle()
...
run(function()
    ...
    StateSpoofer = xyphrion.Categories.Utility:CreateModule({
    	Name = 'State Spoofer',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    FastInteract = xyphrion.Categories.World:CreateModule({
        Name = 'Fast Interact',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    Freecam = xyphrion.Categories.World:CreateModule({
    	Name = 'Freecam',
    	Function = function(callback)
    		if callback then
    			repeat
...
run(function()
    ...
    Gravity = xyphrion.Categories.World:CreateModule({
    	Name = 'Gravity',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    Parkour = xyphrion.Categories.World:CreateModule({
    	Name = 'Parkour',
    	Function = function(callback)
    		if callback then 
    			local oldfloor
...
run(function()
    ...
    PromptExtender = xyphrion.Categories.World:CreateModule({
...
run(function()
    ...
    Xray = xyphrion.Categories.World:CreateModule({
    	Name = 'Xray',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    MurderMystery = xyphrion.Categories.Minigames:CreateModule({
    	Name = 'Murder Mystery',
    	Function = function(callback)
    		if callback then
