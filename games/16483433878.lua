...
run(function()
    ...
    AutoAction = xyphrion.Categories.Combat:CreateModule({
    	Name = 'Auto Action',
...
run(function()
    ...
    AntiHazard = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Anti Hazard',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    FlyingAttack = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Flying Attack',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    PickupTP = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'PickupTP',
    	Function = function(callback)
    		if callback then
    			local old
...
run(function()
    ...
    SpeedSpin = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Speed Spin',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    PickupTracers = xyphrion.Categories.Render:CreateModule({
    	Name = 'Pickup Tracers',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    AutoCamel = xyphrion.Categories.Minigames:CreateModule({
    	Name = 'Auto Camel',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    AutoCloudGrind = xyphrion.Categories.Minigames:CreateModule({
...
run(function()
    ...
    AutoFish = xyphrion.Categories.Minigames:CreateModule({
    	Name = 'Auto Fish',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    AutoPaint = xyphrion.Categories.Minigames:CreateModule({
    	Name = 'Auto Paint',
    	Function = function(callback)
    		if callback then
