...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('xyphrion/assets/new/blur.png')
...
local function isFriend(plr, recolor)
	if xyphrion.Categories.Friends.Options['Use friends'].Enabled then
		local friend = table.find(xyphrion.Categories.Friends.ListEnabled, plr.Name) and true
		if recolor then
			friend = friend and xyphrion.Categories.Friends.Options['Recolor visuals'].Enabled
		end
		return friend
	end
	return nil
...
local function isTarget(plr)
	return table.find(xyphrion.Categories.Targets.ListEnabled, plr.Name) and true
end
getgenv().isTarget = isTarget

local function notif(...) return xyphrion:CreateNotification(...) end
...
run(function()
	...
	xyphrion:Clean(entitylib.Events.LocalAdded:Connect(updateVelocity))
end)
entitylib.start()
...
run(function()
	...
	if not canDebug then
		local cheatenginelib = loadstring(downloadFile('xyphrion/libraries/cheatenginelib.lua'), 'cheatenginelib')(vape, vapeEvents, entitylib)
		require = function(v) 
...
run(function()
	...
	local packages = httpService:JSONDecode(downloadFile('xyphrion/profiles/packages.json'))	
	...
	for _, event in {'MatchEndEvent', 'EntityDeathEvent', 'BedwarsBedBreak', 'BalloonPopped', 'AngelProgress', 'GrapplingHookFunctions'} do
		...
		bedwars.Client:WaitFor(event):andThen(function(connection)
			xyphrion:Clean(connection:Connect(function(...)
				vapeEvents[event]:Fire(...)
			end))
		end)
	end

	xyphrion:Clean(bedwars.ZapNetworking.EntityDamageEventZap.On(function(...)
		local a = {
			entityInstance = ...,
			damage = select(2, ...),
			damageType = select(3, ...),
	...
	xyphrion:Clean(workspace.ChildAdded:Connect(function(projectile)
	...
	for _, event in {'BreakBlockEvent'} do
		xyphrion:Clean(bedwars.ZapNetworking[event..'Zap'].On(function(...)
			local data = {
				blockRef = {
					blockPosition = ...,
				},
	...
	task.spawn(function()
		pcall(function()
			repeat task.wait() until store.matchState ~= 0 or xyphrion.Loaded == nil
			if xyphrion.Loaded == nil then return end
			store.map = waitForChildYield(workspace, 9e9, 'Map', 'Worlds'):GetChildren()[1]
			mapname = store.map.Name
			mapname = string.gsub(string.split(mapname, '_')[2] or mapname, '-', '') or 'Blank'
			if store.map then
				xyphrion:Clean(store.map.Blocks.ChildAdded:Connect(function(v) -- bedwars game is so bad bro 😭 how did you even break this event
					task.delay(0, function()
	...
	xyphrion:Clean(vapeEvents.BedwarsBedBreak.Event:Connect(function(bedTable)
		if bedTable.player and bedTable.player.UserId == lplr.UserId then
			beds:Increment()
		end
	end))

	xyphrion:Clean(vapeEvents.MatchEndEvent.Event:Connect(function(winTable)
		if (bedwars.Store:getState().Game.myTeam or {}).id == winTable.winningTeamId or lplr.Neutral then
			wins:Increment()
		end
	end))

	xyphrion:Clean(vapeEvents.EntityDeathEvent.Event:Connect(function(deathTable)
	...
	pcall(function()
		if getthreadidentity and setthreadidentity or not canDebug then
			...
			task.spawn(function()
				repeat
					task.wait(0.1)
				until xyphrion.Loaded == nil or bedwars.AppController:isAppOpen('BedwarsItemShopApp')
...
run(function()
    ...
    AimAssist = xyphrion.Categories.Combat:CreateModule({
    	Name = 'Aim Assist',
...
run(function()
    ...
    AutoClicker = xyphrion.Categories.Combat:CreateModule({
    	Name = 'Auto Clicker',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    xyphrion.Categories.Combat:CreateModule({
        Name = 'No Click Delay',
        Function = function(callback)
            if callback then
...
run(function()
    if canDebug then
    	run(function()
    		...
    		Reach = xyphrion.Categories.Combat:CreateModule({
    			Name = 'Reach',
...
run(function()
    ...
    ShopQuickBuy = xyphrion.Categories.Combat:CreateModule({
        Name = 'Shop Clicker',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    TriggerBot = xyphrion.Categories.Combat:CreateModule({
        Name = 'Trigger Bot',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    Velocity = xyphrion.Categories.Combat:CreateModule({
        Name = 'Velocity',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AntiDeath = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Anti Death',
...
run(function()
    ...
    AntiFall = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Anti Fall',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoDodge = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Auto Dodge',
...
run(function()
    ...
    AutoKaida = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Auto Kaida',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    DamageBoost = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Damage Boost',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    FastBreak = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Fast Break',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    Fly = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Fly',
        Function = function(callback)
...
run(function()
    ...
    HitBoxes = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Hit Boxes',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    InstantKill = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Instant Kill',
        Function = function(callback)
            if callback then
...
run(function()
    xyphrion.Categories.Blatant:CreateModule({
        Name = 'Keep Sprint',
        Function = function(callback)
...
run(function()
    ...
    Killaura = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Killaura',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    LongJump = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Long Jump',
        Function = function(callback)
...
run(function()
    ...
    MouseTP = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Mouse TP',
    	Function = function(callback)
    		if callback then
    			local position = nil
...
run(function()
    ...
    OwlAura = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Owl Aura',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    PlayerAttach = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Player Attach',
...
run(function()
    ...
    ProjectileAimbot = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    ProjectileAura = xyphrion.Categories.Blatant:CreateModule({
...
run(function()
    ...
    Speed = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Speed',
        Function = function(callback)
...
run(function()
    ...
    Spider = xyphrion.Categories.Blatant:CreateModule({
    	Name = 'Spider',
    	Function = function(callback)
    		if callback then
    			if Truss then
...
run(function()
    ...
    TerraAimbot = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Terra Aimbot',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    VulcanAimbot = xyphrion.Categories.Blatant:CreateModule({
        Name = 'Vulcan Aimbot',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    ArmorHighlight = xyphrion.Categories.Render:CreateModule({
...
run(function()
    ...
    BedESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Bed ESP',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    HiveESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Beehive ESP',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    CustomTags = xyphrion.Categories.Render:CreateModule({
    	Name = 'Custom Tags',
    	Function = function(callback)
    		if callback then
    			CompleteTagEffect()
...
run(function()
    ...
    GeneratorESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Generator ESP',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    Health = xyphrion.Categories.Render:CreateModule({
    	Name = 'Health',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    ItemESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Item ESP',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    KitESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Kit ESP',
    	Function = function(callback)
    		if callback then
    			repeat
...
run(function()
    ...
    NameTags = xyphrion.Categories.Render:CreateModule({
    	Name = 'Name Tags',
    	Function = function(callback)
    		if callback then
    			...
    			if ColorFunc[methodused] then
    				NameTags:Clean(xyphrion.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
    ...
    BulletTracers = xyphrion.Categories.Render:CreateModule({
...
run(function()
    ...
    Shader = xyphrion.Categories.Render:CreateModule({
    	Name = 'Shader',
    	Function = function(callback)
    		if callback then
    			if vape.ThreadFix then
...
run(function()
    ...
    StorageESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Storage ESP',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    xyphrion.Categories.Render:CreateModule({
    	Name = 'Stream Remover',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    TrapESP = xyphrion.Categories.Render:CreateModule({
    	Name = 'Trap ESP',
    	Function = function(callback)
    		if callback then
    			repeat
...
run(function()
    ...
    ViewmodelVisuals = xyphrion.Categories.Render:CreateModule({
...
run(function()
    ...
    AntiLasso = xyphrion.Categories.Utility:CreateModule({
        Name = 'Anti Lasso',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AntiSuffocate = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Anti Suffocate',
    	Function = function(call)
    		if call then
    			repeat
...
run(function()
    ...
    AutoBalloon = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Balloon',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoCounter = xyphrion.Categories.Utility:CreateModule({
...
run(function()
    ...
    AutoLasso = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Lasso',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    AutoPearl = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Auto Pearl',
    	Function = function(callback)
    		if callback then
    			local check, lasty
...
run(function()
    ...
    AutoPlay = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Play',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoRelease = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Auto Release',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    AutoShoot = xyphrion.Categories.Utility:CreateModule({
    	Name = 'Auto Shoot',
    	Function = function(call)
    		if call then
    			local start = tick()
...
run(function()
    ...
    AutoToxic = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Toxic',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoVoidDrop = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Void Drop',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    BackTrack = xyphrion.Categories.Utility:CreateModule({
        Name = 'Back Track',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    CheatDetector = xyphrion.Categories.Utility:CreateModule({
        Name = 'Cheat Detector',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    FakeLag = xyphrion.Categories.Utility:CreateModule({
        Name = 'Fake Lag',
        Function = function(callback)
            if callback then
                rng = Random.new()
...
run(function()
    ...
    KnockbackDelay = xyphrion.Categories.Utility:CreateModule({
...
run(function()
    ...
    MissileTP = xyphrion.Categories.Utility:CreateModule({
        Name = 'Missile TP',
        Function = function(callback)
            if callback then
                MissileTP:Toggle()
...
run(function()
    ...
    PickupRange = xyphrion.Categories.Utility:CreateModule({
        Name = 'Pickup Range',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    RavenTP = xyphrion.Categories.Utility:CreateModule({
        Name = 'Raven TP',
        Function = function(callback)
            if callback then
                RavenTP:Toggle()
...
run(function()
    ...
    Scaffold = xyphrion.Categories.Utility:CreateModule({
        Name = 'Scaffold',
        Function = function(callback)
            if label then
...
run(function()
    ...
    ShopTierBypass = xyphrion.Categories.Utility:CreateModule({
...
run(function()
    ...
    local function staffFunction(plr, checktype)
        if not xyphrion.Loaded then
            repeat task.wait() until xyphrion.Loaded
        end
        ...
        elseif Mode.Value == 'Profile' then
            ...
            if vape.Profile ~= Profile.Value then
                xyphrion:Load(true, Profile.Value)
            end
    ...
    local function playerAdded(plr)
        ...
        elseif getRole(plr, 5774246) >= 100 then
            ...
            if table.find(blacklistedclans, plr:GetAttribute('ClanTag')) and xyphrion.Loaded and Clans.Enabled then
                connection:Disconnect()
    ...
    StaffDetector = xyphrion.Categories.Utility:CreateModule({
        Name = 'Staff Detector',
        Function = function(callback)
            if callback then
...
run(function()
    TrapDisabler = xyphrion.Categories.Utility:CreateModule({
        Name = 'Trap Disabler',
...
run(function()
    xyphrion.Categories.World:CreateModule({
        Name = 'Anti-AFK',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoSuffocate = xyphrion.Categories.World:CreateModule({
        Name = 'Auto Suffocate',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    AutoTool = xyphrion.Categories.World:CreateModule({
        Name = 'Auto Tool',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    BedAssist = xyphrion.Categories.World:CreateModule({
        Name = 'Bed Assist',
        Function = function(call)
            if call then
                repeat
...
run(function()
    ...
    BedProtector = xyphrion.Categories.World:CreateModule({
        Name = 'Bed Protector',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    BlockIn = xyphrion.Categories.World:CreateModule({
    	Name = 'Block-In',
    	Function = function(callback)
    		if callback then
...
run(function()
    ...
    ChestSteal = xyphrion.Categories.World:CreateModule({
        Name = 'Chest Steal',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    FastPlace = xyphrion.Categories.World:CreateModule({
    	Name = 'Fast Place',
    	Function = function(call)
...
run(function()
    ...
    Schematica = xyphrion.Categories.World:CreateModule({
        Name = 'Schematica',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    ArmorSwitch = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Armor Switch',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoBank = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Auto Bank',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoBuy = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Auto Buy',
        Function = function(callback)
            if callback then
                repeat task.wait() until store.queueType ~= 'bedwars_test'
...
run(function()
    ...
    AutoConsume = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Auto Consume',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoFish = xyphrion.Categories.Inventory:CreateModule({
    	Name = 'Auto Fish',
    	Function = function(call)
    		if call then
...
run(function()
    ...
    vape.Components.HotbarList = function(optionsettings, children, api)
        ...
        textbuttonicon.Image = getcustomasset('xyphrion/assets/new/add.png')
    ...
    AutoHotbar = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Auto Hotbar',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoSteal = xyphrion.Categories.Inventory:CreateModule({
    	Name = 'Auto Steal',
    	Function = function(call)
    		if call then
    			repeat
...
run(function()
    ...
    local FastConsume = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Fast Consume',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    FastDrop = xyphrion.Categories.Inventory:CreateModule({
        Name = 'Fast Drop',
        Function = function(callback)
            if callback then
                repeat
...
run(function()
    ...
    AutoHonor = xyphrion.Categories.Minigames:CreateModule({
        Name = 'Auto Honor',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    BedPlates = xyphrion.Categories.Minigames:CreateModule({
    	Name = 'Bed Plates',
    	Function = function(callback)
    		if callback then
    			for _, v in collectionService:GetTagged('bed') do
...
run(function()
                ...
                local mounted = bedwars.Roact.mount(create('BillboardGui', {
                    ...
                    create('Frame', {
                        ...
                        create('ImageLabel', {
                            ...
                            BackgroundTransparency = 1,
                            Image = getcustomasset('xyphrion/assets/new/blur.png'),
    ...
    Breaker = xyphrion.Categories.Minigames:CreateModule({
        Name = 'Breaker',
        Function = function(callback)
            if callback then
                for _ = 1, 30 do
...
run(function()
    ...
    AutoCobalt = xyphrion.Categories.Kits:CreateModule({
        Name = 'Auto Cobalt',
        Function = function(callback)
            if callback then
...
run(function()
    ...
    AutoKit = xyphrion.Categories.Utility:CreateModule({
        Name = 'Auto Kit',
        Function = function(callback)
            if callback then
